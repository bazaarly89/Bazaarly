...
const SECTIONS = [
  ['Acceptance of Terms', 'By accessing or using Bazaarly, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree, please do not use the site.'],
  ...
  ['Intellectual Property', 'All content on this site — including logos, product photography, and text — is the property of Bazaarly or its licensors and may not be reproduced without permission.'],
  ['Limitation of Liability', 'Bazaarly is not liable for indirect, incidental, or consequential damages arising from use of the site or products purchased through it, to the maximum extent permitted by law.'],
